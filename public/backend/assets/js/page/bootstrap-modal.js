...
$("#modal-6").fireModal({
  body: '<p>Now you can see something on the left side of the footer.blade.php.</p>',
  created: function(modal) {
    modal.find('.modal-footer.blade.php').prepend('<div class="mr-auto"><a href="#">I\'m a hyperlink!</a></div>');
  },
  buttons: [
    {
      text: 'No Action',
